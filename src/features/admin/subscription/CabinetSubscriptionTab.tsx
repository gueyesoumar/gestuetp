  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="grid grid-cols-2 sm:grid-cols-5 rounded-xl border border-gray-200 bg-white overflow-hidden">
        ...
        <Stat label="MRR net" value={`${state.mrr.toLocaleString('fr-FR')} €`} />
      ...
      <div className="grid lg:grid-cols-3 gap-4 items-start">
        ...
        <SubscriptionMrrPanel mrr={state.mrr} discountPct={state.discount_pct ?? 0} platformMrr={platformMrr} busy={busy} onAct={act} />
      </div>
