...
import type { FeatureCatalogItem } from '../plans/useFeatureCatalog'
...
export function FeatureDeleteModal({ feature, onClose, onConfirm }: FeatureDeleteModalProps): JSX.Element {
      ...
      <div className="bg-white rounded-xl max-w-md w-full overflow-hidden shadow-2xl">
        ...
        <div className="px-5 py-4">
          ...
          <textarea
            ...
            disabled={submitting}
          />
          {errorMsg && <div className="mt-3 bg-red-50 border border-red-200 rounded-lg p-2.5 text-[12px] text-red-700">{errorMsg}</div>}
        </div>
