...
export function ProfileSettingsTab(): JSX.Element | null {
  ...
  const { updateProfile, updating, error: profileError } = useUpdateProfile(() => setProfileSuccess(true))
  ...
  return (
    <div>
      <div className="mb-6 flex items-center gap-5">
        <div className="flex h-16 w-16 items-center justify-center rounded-full bg-forest-100 text-forest-700 text-xl font-bold">{initials}</div>
        <div>
      ...
      <div className="max-w-3xl space-y-6">
        ...
        {profileSuccess && <div className="rounded-lg bg-green-50 p-3 text-[13px] text-green-700">Profil mis &agrave; jour.</div>}
        ...
        {passwordSuccess && <div className="rounded-lg bg-green-50 p-3 text-[13px] text-green-700">Mot de passe modifi&eacute;.</div>}
