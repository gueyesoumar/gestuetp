...
export function HeroScoreCard({ score, approvedControls, totalControls }: HeroScoreCardProps){
  ...
  return (
    <div className="relative text-center py-10 bg-white border border-gray-200 rounded-xl overflow-hidden mb-6">
      ...
      <p className="text-sm text-gray-500">{approvedControls} contr&ocirc;les conformes sur {totalControls}</p>
    </div>
  )
}
