  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <DashboardKpiCard icon={<BarChart3 className="h-3.5 w-3.5" />} iconBg="bg-forest-100 text-forest-700" label="Avancement moy." value={`${stats.averageProgress}%`} sub={`${stats.averageProgress}% des contrôles évalués`} info="Part moyenne des contrôles évalués (non brouillon) sur les missions actives" barColor="bg-emerald-500" valueColor={stats.averageProgress >= 80 ? 'text-emerald-600' : stats.averageProgress >= 60 ? 'text-gold-600' : 'text-red-600'} />
