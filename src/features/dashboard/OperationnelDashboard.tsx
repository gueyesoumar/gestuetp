  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <DashboardKpiCard icon={<FileEdit className="h-3.5 w-3.5" />} iconBg="bg-gold-200 text-gold-600" label="À documenter" value={remaining} sub="brouillons en cours" info="Contrôles non encore soumis (brouillons ou non commencés)" barColor="bg-gold-500" valueColor="text-gold-600" />
