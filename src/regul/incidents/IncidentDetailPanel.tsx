...
interface Props { incident: Incident; entityName: string; onClose: () => void; onChanged: () => void }
...
export function IncidentDetailPanel({ incident, entityName, onClose, onChanged }: Props): JSX.Element {
